...
# Parameters
IMAGE_FOLDER=/home1/nilaksh/datasets/COCO/val2017/
#IMAGE_FOOT_FOLDER=~/devel/images/val2017_foot/
JSON_FOLDER=../evaluation/
...
$OP_BIN --image_dir $IMAGE_FOLDER --display 0 --render_pose 0 --cli_verbose 0.2 --write_coco_json ${JSON_FOLDER}1_max.json --write_coco_json_variants 3 --maximize_positives
